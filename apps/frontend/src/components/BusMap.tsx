            ...
            {infoDialog === "about" ? (
              <div className="info-modal-body">
                ...
                <a
                  ...
                  href="https://github.com/JGBotelho17/projeto-stcp-live-tracking-real-time"
                  target="_blank"
                  rel="noreferrer"
                >
                  <GitHubIcon />
                  <span>JGBotelho17</span>
                </a>
              </div>
            ) : (
